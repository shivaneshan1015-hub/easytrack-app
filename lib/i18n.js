...
export const translations = {
  ...
  ta: {
    // Navigation & Sidebar (Tamil - தமிழ்)
    app_name: 'ஈசிட்ராக்',
    ...
    pricing: '💰 விலை விவரம்',
    add_new_shop: 'புதிய கடை சேர்',
    shop_name: 'கடையின் பெயர்',
    phone: 'தொலைபேசி',
    address: 'முகவரி',
    all_shops: 'அனைத்து கடைகள்',
    no_shops: 'கடைகள் எதுவும் இல்லை.',
    credit_limit: 'கடன் வரம்பு (₹)',
    credit_usage: 'பயன்படுத்திய கடன்',
    gps: 'ஜிபிஎஸ்',
    name: 'பெயர்',
  ...
  hi: {
    // Navigation & Sidebar (Hindi - हिन्दी)
    app_name: 'इजीट्रैक',
